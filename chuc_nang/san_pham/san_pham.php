...
<div class="panel panel-warning">
    <div class="panel-heading">Sản phẩm mua nhiều</div>
    <div class="panel-body">
		<div class="product">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="product">
			<?php
				include('connect.php');
				$sl= 'select * from san_pham where mua_nhieu > "10" ORDER BY mua_nhieu DESC limit 0,4';
				$exec= mysqli_query($connect, $sl);
				while($row= mysqli_fetch_array($exec)){
			?>
					<div class="sp img-thumbnail col-xs-12 col-sm-6 col-md-6 col-lg-3">
			...
			?>	
				<div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<a href="?menu=mua_nhieu" class="text-center btn btn-default">Xem thêm</a>
				</div>
			<?php
				}
			?>
...
<div class="panel panel-warning">
    ...
    <div class="panel-body">
		<div class="product">
			...
			<?php
				include('connect.php');
				$sl= 'select * from san_pham ORDER BY masp DESC limit 0,4';
				$exec= mysqli_query($connect, $sl);
				while($row= mysqli_fetch_array($exec)){
			?>
					<div class="sp img-thumbnail col-xs-12 col-sm-6 col-md-6 col-lg-3">
			...
			?>
				<div class="text-center col-xs-12 col-sm-12 col-md-12 col-lg-12">
					<a href="?menu=sp_moi" class="text-center btn btn-default">Xem thêm</a>
				</div>
			</div>
		</div>
	</div>
